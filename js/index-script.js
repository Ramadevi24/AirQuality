        ...
        success: function (data) {
            try {
                ...
                $("#mainPollutantName").html(mainPollutantNameContent).css({
                    'background-color': 'rgba(0, 75, 135, 1)',
                    'color': 'white' });
                $("#mainPollutantValue").text(data.pollutantValue + 'ug/m³').css('color', 'rgba(0, 75, 135, 1)');
...
var accordionArabicContent = [
    {
        question: ' ما هي "جودة الهواء"؟',
        answer: "تشير جودة الهواء إلى حالة الهواء المحيط ونقائه. حيث تتعلق جودة الهواء بتركيز الملوثات الجوية المختلفة التي قد تكون ضارة بصحة الانسان والبيئة. "
    },
    {
    ...
    {
        question: "هل تؤثر جودة الهواء على أنماط الطقس؟",
        answer: "نعم، جودة الهواء تؤثر على أنماط الطقس. على سبيل المثال، يمكن أن تؤثر بعض الملوثات على تكوين السحب والهطول."
    },
    {
    ...
    },
    {
        ...
        answer: "يمكن أن يؤدي تلوث الهواء بمستويات مرتفعة والتعرض الطويل له في حدوث مشاكل تنفسية، وتفاقم الحالات الصحية الموجودة، والمساهمة في مشاكل القلب والأوعية الدموية."
    },
    {
    ...
    },
    {
        ...
        answer: "ثاني أكسيد الكبريت (SO2) هو غاز عديم اللون ذو رائحة لاذعة. يتكون من ذرة واحدة من الكبريت وذرتين من الأكسجين، وصيغته الكيميائية هي SO2. ينتج ثاني أكسيد الكبريت بشكل رئيسي من حرق الوقود الأحفوري الذي يحتوي على الكبريت، مثل الفحم والنفط، في محطات الطاقة ومن خلال بعض العمليات الصناعية. كما يتم إطلاقه خلال الثورات البركانية."
    },
    {
...
function updateToArabic() {
    ...
    agendamobile.textContent = 'تلتزم هيئة البيئة – أبوظبي، التي تأسست في عام 1996، بحماية وتعزيز جودة الهواء، والمياه الجوفية بالإضافة إلى حماية التنوع البيولوجي في النظم البيئية الصحراوية والبحرية في إمارة أبوظبي. ومن خلال الشراكة مع جهات حكومية أخرى، والقطاع الخاص والمنظمات غير الحكومية، والمنظمات البيئية العالمية، تعمل الهيئة على تبني أفضل الممارسات العالمية، وتشجيع الابتكار والعمل الجاد لاتخاذ تدابير، وسياسات فعالة. كما تسعى الهيئة لتعزيز الوعي البيئي، والتنمية المستدامة، وضمان استمرار إدراج القضايا البيئية ضمن أهم الأولويات في الأجندة الوطنية.';
...
function updateToEnglish() {
    ...
    $('.insight #sidebar-btn').removeClass('expandpanelipad');
    // $('.insight .coll-icon').removeClass('expandpanelairpro')
    $('.pollutant-toggleBar .info-popup, .pollutant-toggleBar:first-of-type  .info-topPosition, .pollutant-toggleBar .info-topPosition1').removeClass('mobileinfocnt');
 ...
 $('.equal-station-box-height ').removeClass('pollutent-graph')
    document.querySelectorAll('.insight .silde-dv').forEach(item => {
