...
var imageDataArabic = [
  {
    ...
    description:
      "مشروع الربط الإلكتروني لنظام مراقبة الانبعاثات المستمرة هو مبادرة من حكومة أبوظبي لدعم تحسين جودة البيئة وحماية الصحة العامة. يشمل هذا المشروع جمع بيانات الانبعاثات من أنظمة مراقبة الانبعاثات المستمرة (CEMS) من المنشآت الصناعية وتخزينها في قاعدة بيانات مركزية في هيئة البيئة - أبوظبي، بالإضافة إلى إنشاء آليات للإبلاغ اليدوي للمنشآت التي لا تمتلك أنظمة (CEMS). سيمكن مشروع الربط الإلكتروني هيئة البيئة - أبوظبي من تطوير قاعدة بيانات شاملة تعتمد على البيانات في الوقت الفعلي. كما يتضمن المشروع بوابة الكترونية مصممة ومطبقة لتمكين عرض البيانات في وقت قريب جدا من الوقت الفعلي. سيساعد ذلك هيئة البيئة - أبوظبي على تطوير أفضل الممارسات لمراقبة الانبعاثات وضمان توفر بيانات عالية الجودة. توفر هذه المنصة مجموعة من الميزات مثل نظم المعلومات الجغرافية (GIS)، نماذج التشتت، تنبيهات تجاوز الانبعاثات، إنتاج التقارير المطلوبة، وإدارة سير العمل للبيانات. كما ستضمن البوابة اللاكترونية جودة البيانات المستلمة (سواء الآلية أو اليدوية) وتمكن من التواصل مع المنشآت بشأن أي تناقضات في البيانات.",
  },
  {
    imageUrl: "./images/new-images/Monitoring_network.jpg",
...
var accordionContent = [
  ...
  },
  {
    ...
    answer:
      "Yes, air quality is seen to influence weather patterns. For example, certain pollutants can affect cloud formation and precipitation.",
  },
  {
    question:
...
var accordionArabicContent = [
  ...
  },
  {
    ...
    answer:
      "<ul><li>اختيار وسائل النقل المستدامة.</li> <li>.استخدام الأجهزة الموفرة للطاقة وإيقاف الأجهزة الإلكترونية عند عدم الاستخدام.</li> <li> .اختيار مصادر الطاقة النظيفة مثل الطاقة الشمسية أو طاقة الرياح. </li> <li>.تجنب استخدام المركبات غير الضرورية لتقليل انبعاثات المرور. </li> <li> .استهلاك المنتجات المحلية </li> </ul>",
  },
  {
